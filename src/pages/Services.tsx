                    ...
                    >
                      {brand.logo ? (
                        <img
                          src={brand.logo}
                          alt={brand.name}
                          className="w-14 h-14 sm:w-16 sm:h-16 mx-auto mb-3 object-contain filter brightness-0 invert group-hover:brightness-100 group-hover:invert-0 transition-all duration-300"
                  ...
                  {services.map((svc, i) => (
                    ...
                    >
                      ...
                      <div className="p-4 sm:p-6">
                        ...
                        <Button className="w-full bg-gradient-sky text-primary-foreground font-semibold hover:opacity-90 text-sm">
                  ...
                  {VEHICLE_CATEGORIES.map((cat, i) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className="bg-gradient-card border border-border rounded-xl p-5 sm:p-6 hover:border-primary hover:shadow-sky transition-all duration-300"
                      >
